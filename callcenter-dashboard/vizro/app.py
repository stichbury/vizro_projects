...
# DEFINE DATA
import os
# Try local path first, then MLRun path
if os.path.exists("data.csv"):
    df = pd.read_csv("data.csv")
elif os.path.exists("/home/mlrun_code/vizro/data.csv"):
    df = pd.read_csv("/home/mlrun_code/vizro/data.csv")
else:
    raise RuntimeError("The data file 'data.csv' was not found.")
        ...
        vm.AgGrid(
            ...
            figure=dash_ag_grid(
                ...
                columnDefs=[
                    ...
                    {"field": "Topic"},
                    {"field": "Summary"},
                    {"field": "text_file", "hide": True},
                    {"field": "audio_file", "hide": True},
                ],
            ),
            actions=[
                vm.Action(
